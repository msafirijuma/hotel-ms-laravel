...
<div class="container-fluid">
    ...
    <div class="card shadow mb-5">
        <div class="card-header">Rooms Statistics</div>
        <div class="card-body">
            <div class="row g-4 mb-2">
                    ...
                    <div class="card border-0 shadow-sm h-100 bg-info text-white">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    <h6 class="opacity-75">Total Rooms</h6>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    ...
                                    <h2 class="mb-0">{{ $available_rooms ?? 0 }}</h2>
                                </div>
                                <i class="fas fa-door-open fa-2x text-gray-300"></i>
                            </div>
                        </div>
                        <div class="card-footer">
                            <a href="{{ route('rooms.index') }}" class="btn btn-light btn-sm text-success font-weight-bold">
                                    <i class="fas fa-eye"></i> View Available
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-md-6 col-sm-12">
                    <div class="card border-0 shadow-sm h-100 bg-primary text-white">
                        ...
                        <div class="card-footer">
                            <a href="{{ route('rooms.index') }}" class="btn btn-light btn-sm text-info font-weight-bold">
                                    <i class="fas fa-eye"></i> View Occupied
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-md-6 col-sm-12">
                    <div class="card border-0 shadow-sm h-100 bg-danger text-white">
                        ...
                        <div class="card-footer">
                            <a href="{{ route('rooms.index') }}" class="btn btn-light btn-sm text-danger font-weight-bold">
                                    <i class="fas fa-eye"></i> View Dirty
                            </a>
                        </div>
                    </div>
                </div>
    ...
    <!-- Today's Check-ins and Check-outs Stats -->
    <div class="card shadow mb-5">
        <div class="card-header">Today's Check-ins and Check-outs</div>
        <div class="card-body">
            <div class="row g-4 mb-2">
                <!-- Today's Check-ins -->
                <div class="col-xl-3 col-md-6 col-sm-12">
                    <div class="card border-0 shadow-sm h-100 bg-success text-white">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    <h6 class="opacity-75">Today's Check-ins</h6>
                                    <h2 class="mb-0">{{ $today_checkins ?? 0 }}</h2>
                                </div>
                                <i class="fas fa-sign-in-alt fa-2x text-gray-300"></i>
                            </div>
                        </div>
                        <div class="card-footer">
                            <a href="{{ route('bookings.checkin-checkout') }}" class="btn btn-light btn-sm text-success font-weight-bold">
                                    <i class="fas fa-eye"></i> View Check-ins
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-md-6 col-sm-12">
                    <div class="card border-0 shadow-sm h-100 bg-warning text-white">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    <h6 class="opacity-75">Today's Check-outs</h6>
                                    <h2 class="mb-0">{{ $today_checkouts ?? 0 }}</h2>
                                </div>
                                <i class="fas fa-sign-out-alt fa-2x text-gray-300"></i>
                            </div>
                        </div>
                        <div class="card-footer">
                            <a href="{{ route('bookings.checkin-checkout') }}" class="btn btn-light btn-sm text-warning font-weight-bold">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card shadow mb-3">
                <div class="card-header py-3 bg-primary text-white d-flex justify-content-between align-items-center py-3">
